...
export default function FloorCard({ floor }: FloorCardPropsTypes): React.JSX.Element {
  ...
  // Assuming floor.img is an array of image filenames, fall back to a static array if not
          ...
          >
            <Paper className={styles.carouselImage}>
              <Box
                ...
                alt="Apartment Image"
                className={styles.modalImage} // Use the appropriate style for modal images
              />
            </Paper>
            <Paper className={styles.carouselImage}>
              <Box
