...
import styles from './AddForm.module.css'; // Импортируем стили

export default function AddForm(): JSX.Element {
  const { updateAllPricesHandler } = useAppartments(); // Изменяем на новый метод
    ...
    <>
      ...
      <DialogContent>
        <form onSubmit={updateAllPricesHandler}>
          ...
          <Button
            className={styles.submitButton} // Используем стили
            type="submit"
          >
            Обновить цену
          </Button>
